        ...
        <View style={styles.settingsSection}>
          ...
          >
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingLabel}>Store Management</Text>
            </View>
            <Ionicons
              name={isOpenSubMenu ? "chevron-down" : "chevron-forward"}
              size={18}
              color="#9CA3AF"
            />
          </TouchableOpacity>
          ...
          {isOpenSubMenu && (
            <View style={styles.subMenu}>
              <SubItem
                ...
                onPress={() =>
                  router.push(
                    "/(main)/store_management/material/MaterialListScreen",
                  )
                }
              />
              <SubItem
                ...
                onPress={() =>
                  router.push(
                    "/(main)/store_management/inward/InwardListScreen",
                  )
                }
              />
              <SubItem
                ...
                onPress={() =>
                  router.push(
                    "/(main)/store_management/outward/OutWardListScreen",
                  )
                }
              />
              <SubItem
