...
const FULL_TABS = [
  {
    ...
    label: "Parties",
    icon: ic_parties,
    iconSelected: ic_parties_selected,
  },
  {
    route: "invoices",
    label: "Invoices",
    icon: ic_invoice,
    iconSelected: ic_invoice_selected,
  },
  {
    route: "index",
    label: "Dashboard",
    icon: ic_dashboard,
    iconSelected: ic_dashboard_selected,
  },
  {
    route: "receivables",
    label: "Receivables",
    icon: ic_receivables,
    iconSelected: ic_receivables_selected,
  },
  {
    route: "payables",
    label: "Payables",
    icon: ic_payables,
    iconSelected: ic_payables_selected,
  },
];
...
const CustomTabBar: React.FC<SimpleTabBarProps> = ({
  state,
  navigation,
  tabs,
}) => {
